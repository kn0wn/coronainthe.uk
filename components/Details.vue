  ...
  <div class="container mx-auto">
    <ul>
      <li
        ...
        :key="`detail-${id}`"
        class="p-1 mx-2 my-4 text-xl bg-white bg-opacity-25"
      >
        <div
          class="flex items-center justify-between px-2 py-2 bg-white rounded"
        >
          <p>{{ day.new_infections }}</p>
          <p>{{ $dateFns.format(day.date, 'P') }}</p>
        </div>
      </li>
    </ul>
